 ...
 * and crop if needed, respecting the ratio and cutting off the external parts of the image (i.e centered crop)
 *
 * @author gjoseph
...
public class AutoCropAndResize extends AbstractCropAndResize {
    protected Coords getCroopCoords(BufferedImage source, int targetWidth, int targetHeight) {
        ...
        if (targetWidth <= 0 && targetHeight <= 0) {
            throw new IllegalStateException("Specify at either or both targetWidth and targetHeight");
