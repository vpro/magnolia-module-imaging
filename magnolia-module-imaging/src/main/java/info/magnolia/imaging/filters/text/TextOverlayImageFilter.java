...
public class TextOverlayImageFilter implements ImageFilter<TextStyle> {
    ...
    public BufferedImage apply(BufferedImage src, TextStyle filterParams, Content dialogControlConfigNode) {
...
//        int lineHeight = fontmetrics.getHeight();
        ...
        drawString(g, style, txt, txtPositionX, txtPositionY);
    ...
    protected synchronized void drawString(Graphics2D graphics2d,
                                           TextStyle style, String text, int txtPositionX, int txtPositionY) {
        float f = 0.0F;
        Font font = style.getFont();
        graphics2d.setFont(font);
        graphics2d.setColor(style.getColor());
        FontMetrics fontmetrics = graphics2d.getFontMetrics();
        float f1 = (float) ((double) style.getCharSpacing() / TextStyle.CHARSPACING_DIV_FACTOR);
        ...
        graphics2d.drawGlyphVector(glyphvector, (float) txtPositionX, (float)txtPositionY + style.getFontSize());
    }
